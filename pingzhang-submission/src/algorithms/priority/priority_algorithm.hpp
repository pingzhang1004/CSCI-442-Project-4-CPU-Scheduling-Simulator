...
private:
        ...
        // TODO: Add any member variables you may need
         Stable_Priority_Queue<std::shared_ptr<Thread>> priority_queue;
        //there are 4 priority quene: S, I, N, B. Each Quenue have its own number of threads.
        int count_thread_priQuens[4] = {0};
